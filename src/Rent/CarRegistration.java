...
public class CarRegistration extends javax.swing.JFrame {
    ...
    public void table_update()
    {
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3362/carrental", "root", "Aamer321@");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {                                         
            ...
            try {
                Class.forName("java.sql.Driver");
                con = DriverManager.getConnection("jdbc:mysql://localhost:3362/carrental", "root", "Aamer321@");
