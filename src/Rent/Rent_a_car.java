...
public class Rent_a_car extends javax.swing.JFrame {
    ...
    public void LoadCarid()
    {
        try {
            ...
            java.sql.Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3362/carrental", "root", "Aamer321@");
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        try {
            ...
            pst1 = (PreparedStatement) con.prepareStatement("Select * from carregistration where id =  ?");
